...
train_dl <- dataloader(train_ds, batch_size = 20, shuffle = TRUE, drop_last=TRUE)
test_dl <- dataloader(test_ds, batch_size = 20, drop_last=TRUE)

train_iter <- train_dl$.iter()
train_iter$.next()

#print out the 1st 32 characters
